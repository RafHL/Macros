;-----------------------------------------------------------------------------+
;- File: EEL3744_Macros.ahk  (~\Macros) - GVIM1
;- Created: 08-22-2018 11:32
;- Last Modified: 10-24-2018 16:19
;
;- Name: Rafael Hernandez (RafHL)
;- Description: A file with my most used macros for EEL 3744,
;-     Microprocessor Applications. Feel free to modify and enhance
;-     for your purposes. Be sure to change the title template to suit
;-     your needs.
;-----------------------------------------------------------------------------+
